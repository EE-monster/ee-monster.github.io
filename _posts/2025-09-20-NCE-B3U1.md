...
3. 下划线的使用：
  <u>下划线</u>
  <span style="border-bottom: solid">实线下划线</span>
  <span style="border-bottom: dashed">虚线下划线</span>
  <span style="border-bottom: dotted">点下划线</span>
  <span style="border-bottom: 2px dashed">2像素虚线下划线</span>
  <u style="border-bottom: dashed">下划线虚线</u>
  <u style="border-bottom: 2px dashed">2像素下划线虚线</u>
  <u style="border-bottom: 2px dashed #000">2像素纯黑下划线虚线</u>
...
页内锚点
单向一级标题锚点
**[⬆ top](#什么是-markdown-)** （括号中不能出现大写字母，空格要用连字符代替，标点须忽略）
例：
[🚀L42](#lesson-42---modern-cavemen) 代表转到第42课程，但42的标题中的大写字母全部换成了小写
...
## emoji的使用
emoji尽量选用彩色的，在白底黑字的屏幕上会更明显和活泼。
🌻向日葵代表单词知识点，葵花籽象征一个个单词的集结，向阳而生，周而复始方能记牢。
🕹️游戏操纵杆代表课文知识点，阅读文章就像打游戏，一个个知识点如同一道道关卡，攻克它们直至通关，即代表搞懂了文章。（大脑会遗忘，小怪和Boss们也会重生，所以一定要记得多周目哦~）
⭐星星仅在记笔记的时候用，是表示上次学习结束时的临时存档点，再次打开继续学习时，将其删除即可。
🌙
🚀🪐火箭和行星是页内正文锚点的标记，可点击跳转。
🌏地球表示目录，可点击跳转。
待用emoji：⚓🌊🕸️🛸🎯
...
修改：
笔记中的“ ' ”应改成“ ‘ ”或“ ’ ”   ‘’
美元符号“$”不可在同一行或相邻行出现两次，如必须在同一行，可换用“＄”

否则会变成衬线体（$beautiful$）


**<font color=green>optunity</font>**
